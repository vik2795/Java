...
class UserInputField(UserControl):
    ...
    def build(self):
        return Container(
            ...
            height=40,
            border=border.only(
                bottom=border.BorderSide(0.5, "#C7B7A3"),
            ),
            border_radius=6,
            content=Row(
                spacing=20,
            ...
            content=Container(
                ...
                content=Column(
                    ...
                    controls=[
                        ...
                        Stack(
                            controls=[
                                AnimatedBox("#B5C18E", None, 0),
                                AnimatedBox("B5C18E", "#C7B7A3", pi / 4),
                            ]
                        ),
                        ...
                        Column(
                            ...
                            spacing=5,
                            controls=[
                                Text("Bejelentkezés", size=22, weight="bold"),
                                Text(
                                    "Elképesztően biztonságos oldal",
                                    size=13,
                                    weight="bold",
                                ),
                            ],
                        ...
                        Row(
                            ...
                            controls=[
                                Container(
                                    content=Text("Van baj?", size=9),
                                )
                            ],
                        ),
                        Divider(height=45, color="transparent"),
                        SignInButton("Na menjen" ),
